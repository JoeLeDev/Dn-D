...
const GRAPHQL_URL = process.env.NEXT_PUBLIC_GRAPHQL_URL || 'https://readonlydemo.vendure.io/shop-api';
...
async function fetchAllProducts() {
  ...
  while (hasMore) {
    ...
    console.log(`  ${products.length} produits récupérés (total: ${allProducts.length}/${data.products.totalItems})`);
